            ...
            <div className="flex flex-col h-full w-full animate-pulse">
                <main className="flex-1 overflow-y-auto p-4 sm:p-6 bg-[#f8fafc]">
                    <div className="flex justify-between items-center mb-6">
                        <div><div className="h-7 w-40 bg-slate-200 rounded mb-2" /><div className="h-4 w-56 bg-slate-100 rounded" /></div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {[1, 2, 3, 4, 5, 6].map(i => (
                                <div key={i} className="bg-white rounded-2xl p-4 ring-1 ring-slate-100 flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-xl bg-slate-200" />
                                    <div className="flex-1"><div className="h-4 w-24 bg-slate-200 rounded mb-2" /><div className="h-3 w-32 bg-slate-100 rounded" /></div>
                                </div>
                            ))}
                        </div>
                    </div>
